<template>
  <div>
    ...
    <Navbar />
      <div class="flex card">
        <div class="mx-4 rounded-lg" v-for="(lecture,index) in lectures" :key="lecture.id">
          <div class="w-full card-img relative">
            <div class="flex absolute right-7 bottom-7">
              <svg class="" width="18" height="23" viewBox="0 0 18 23" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button @click="addToCart(lecture.id)">
        ...
        <div class="px-6 py-4">
          <div class="font-bold text-xl mb-2">{{ lecture.title }}</div>
            ...
            <div class="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
              <div class="bg-red-600 h-2.5 rounded-full dark:bg-red-500" :style="{ 'width': getProgress(index)+'%'}">
              </div>
            </div>
          </div>
